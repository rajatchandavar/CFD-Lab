...
void CUDA_solver::pre_process(Fields &field, Grid &grid, Discretization &discretization){
    ...
    var = GEOMETRY_PGM::inflow_id;
    cudaMemcpy(inflow_id, &var, sizeof(int),cudaMemcpyHostToDevice);
    var = GEOMETRY_PGM::outflow_id;
    cudaMemcpy(outflow_id, &var, sizeof(int),cudaMemcpyHostToDevice);
    var = GEOMETRY_PGM::hot_id;
    cudaMemcpy(hot_id, &var, sizeof(int),cudaMemcpyHostToDevice);
    var = GEOMETRY_PGM::cold_id;
    cudaMemcpy(cold_id, &var, sizeof(int),cudaMemcpyHostToDevice);
